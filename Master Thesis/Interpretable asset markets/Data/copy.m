...
% Data Input
% CRSP
cd('E:\研一暑假\WISE\Ren yu\Interpretable asset markets\Data\CRSP')
...
% NIPA
cd('E:\研一暑假\WISE\Ren yu\Interpretable asset markets\Data\NIPA')

% 1948q4 - 1969q4
US_NIPA_E_1 = xlsread('Section1All_Hist.xls','11400 Qtr','K22:CQ22');
% 1970q1 - 1999q4
US_NIPA_E_2 = xlsread('Section1all_xls.xls','11400 Qtr','H22:DW22');
US_NIPA_E = [US_NIPA_E_1, US_NIPA_E_2]; 

% 1948q4 - 1999q4
US_NIPA_NonDurable_1 = xlsread('Section1All_Hist.xls','10105 Qtr','K14:CQ14');
US_NIPA_Service_1 = xlsread('Section1All_Hist.xls','10105 Qtr','K15:CQ15');
...
US_NIPA_percapita_Nondurable_current_1 = xlsread('Section7All_Hist.xls','70100 Qtr','K18:CQ18');
US_NIPA_percapita_Service_current_1 = xlsread('Section7All_Hist.xls','70100 Qtr','K19:CQ19');
...
US_NIPA_percapita_Nondurable_2009_1 = xlsread('Section7All_Hist.xls','70100 Qtr','K27:CQ27');
US_NIPA_percapita_Service_2009_1 = xlsread('Section7All_Hist.xls','70100 Qtr','K28:CQ28');
...
%% Construct data
%
% construct month data (1948.10-1999.12)

US_mdata = US_mdata(10:end,:);

mP = US_mdata(:,4).';

mP_index = 1; % Set price_index of 1948.10 as 1
...
% construct quarterly data (1948q4-1999q4)

US_qdata = US_qdata(4:end,:); % (1948q4-1999q4)

qP = US_qdata(:,4).'; % (1948q4-1999q4)

qP_index = mP_index(3:3:end); % (1948q4-1999q4)

qD_index = mD_index(1:3:end) + mD_index(2:3:end) + mD_index(3:3:end); % (1948q4-1999q4)

% deseasonalized
qD_index_deseasonalized = qD_index;
qD_index_deseasonalized(2) = (qD_index(2)+ qD_index(3))/2;
qD_index_deseasonalized(3) = (qD_index(1) + qD_index(2) + qD_index(3))/3;

qD_index_deseasonalized(4:end) = (qD_index(1:end-3) + qD_index(2:end-2)...
    + qD_index(3:end-1) + qD_index(4:end))./4;

qD_index = qD_index_deseasonalized;

qE = US_NIPA_E; % (1948q4-1999q4)

qE_index = qP_index(1:end-1).*qE(2:end)./qP(1:end-1); % (1949q1-1999q4)

% % deseasonalized
% qE_index_deseasonalized = qE_index;
% qE_index_deseasonalized(2) = (qE_index(2)+ qE_index(3))/2;
% qE_index_deseasonalized(3) = (qE_index(1) + qE_index(2) + qE_index(3))/3;
% 
% qE_index_deseasonalized(4:end) = (qE_index(1:end-3) + qE_index(2:end-2)...
%     + qE_index(3:end-1) + qE_index(4:end))./4;
% 
% qE_index = qE_index_deseasonalized;



qC = US_NIPA_C; % (1948q4-1999q4)

qR_m = (qD_index(2:end) + qP_index(2:end))./qP_index(1:end-1) - 1; % (1949q1-1999q4)

qP_c = US_P_c; % (1948q4-1999q4)
...
% save data_complete_deseasonallized_DE;
% save data_complete_deseasonallized_D;
...
% load('data_complete_deseasonallized_DE.mat')
